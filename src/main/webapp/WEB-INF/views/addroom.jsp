...
<path
    ...
    <div class="row">
      <div class="col-4 hero p-5 position-relative">
        <img style="max-height: 550px; position: absolute; left:150px; bottom:0;" src="https://raw.githubusercontent.com/uni-preetham/Test/master/1000041632-removebg.png">
        </div>
        <div class="col-8 p-5 d-flex flex-column justify-content-center">
            <h2 class="text-center mb-3">Add Room</h2>
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <form id="addRoomForm" action="${pageContext.request.contextPath}/room/createroom" method="post" novalidate>
                        <!-- Hostel Selection -->
                        <div class="form-group form-floating mb-2">
                            <select class="form-control" id="hostel" name="hostelId" required>
                            ...
                            <div class="invalid-feedback">Hostel selection is required.</div>
                        </div>
                        
                        <!-- Room Number -->
                        <div class="form-group form-floating mb-2">
                            <input type="text" class="form-control" id="roomNumber" name="roomNumber" placeholder="" maxlength="10" pattern="\d+" required>
                        ...
                        <!-- Room Floor Number -->
                        <div class="form-group form-floating mb-2">
                            <input type="number" class="form-control" id="roomFloorNumber" name="roomFloorNumber" placeholder="" min="1" max="999" required>
                        ...
                        <!-- Price per Day -->
                        <div class="form-group form-floating mb-2">
                            <input type="number" step="0.01" class="form-control" id="price" name="price" placeholder="" min="0" max="999999" required>
                        ...
                        <div class="btn-group mb-2" role="group" aria-label="Basic checkbox toggle button group">
                            <input type="checkbox" class="btn-check" id="availability" name="availability" checked>
                            <label class="btn btn-outline-primary" for="availability" id="availabilityLabel">Available</label>
                        </div>

                        <!-- Submit Button -->
                        <button type="submit" class="button w-100 btn-block">Add Room</button>
                    </form>
                </div>
            </div>
        </div>
