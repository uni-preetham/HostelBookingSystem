		...
		<div class="row" style="height: 100vh;">
			<div class="col-4 hero p-5">
				...
				<ul class="card rounded p-4"
					...
					<li class="my-2 text-dark d-flex justify-content-between">Booking
						ID <span class=" fw-semibold">${booking.bookingId}</span>
					</li>
					<li
						...
						<div class="col-md-6">
							...
							<form
								...
								<div id="upiForm" style="display: none;" class="text-center">
									<img style="width: 140px; height: 140px; aspect-ratio: 1/1;"
