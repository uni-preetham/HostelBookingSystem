			...
			<div class="col-8 d-flex flex-column justify-content-center">
				...
				<div class="row justify-content-center">
					<div class="col-md-6">
						...
						<form
							action="${pageContext.request.contextPath}/tenant/resetPassword"
							method="post">
							...
							<div class="form-group form-floating mb-2">
								<input type="password" id="newPassword" name="newPassword"
									...
									placeholder="" required> <label for="newPassword">Enter
									New Password</label>
							...
							<button type="submit" class="button w-100 btn-block my-3">Change
								Password</button>
						</form>
