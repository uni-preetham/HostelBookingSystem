			...
			<div class="row">
				...
				<div class="col-8 p-5 d-flex flex-column justify-content-center">
					...
					<div class="row justify-content-center">
						<div class="col-md-6">
							<form
								action="${pageContext.request.contextPath}/tenant/updatetenant"
								method="post">
								<!-- Hidden input to keep the tenant ID -->
								...
								<div class="form-group form-floating mb-2">
									<input type="text" id="tenantFname" name="tenantFname"
										class="form-control" value="${tenant.tenantFname}"
										placeholder="" required> <label for="tenantFname">First
										Name</label>
								</div>

								<div class="form-group form-floating mb-2">
									<input type="text" id="tenantLname" name="tenantLname"
										class="form-control" value="${tenant.tenantLname}"
										placeholder="" required> <label for="tenantLname">Last
										Name</label>
								</div>

								<div class="form-group form-floating mb-2">
									<input type="email" id="tenantEmail" name="tenantEmail"
										class="form-control" value="${tenant.tenantEmail}"
										placeholder="" required> <label for="tenantEmail">Email</label>
								</div>

								<div class="form-group form-floating mb-2">
									<input type="text" id="tenantPhone" name="tenantPhone"
										class="form-control" value="${tenant.tenantPhone}"
								...
								<a href="${pageContext.request.contextPath}/tenant/dashboard"
									 style="background: white!important;display:block;text-decoration:none; color: black;" class="button w-100 btn-block">Cancel</a>
							</form>
						</div>
					</div>
				</div>
