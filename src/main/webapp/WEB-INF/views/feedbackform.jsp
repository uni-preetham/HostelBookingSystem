...
<path
    ...
    <div class="row" style="height: 80vh;">
        ...
        <div class="col-8 p-5 d-flex flex-column justify-content-center">
            <h2 class="text-center mb-3">Feedback</h2>
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <form id="feedbackForm" action="${pageContext.request.contextPath}/feedback/submit" method="post">
                        ...
                        <button type="submit" class="button btn-block w-100">Submit Feedback</button>
                    </form>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Function to check if the textarea is valid
    ...
    // Attach the validateDescription function to the textarea's input event
