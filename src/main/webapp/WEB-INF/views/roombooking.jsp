<%@ page import="com.crimsonlogic.hostelmanagementsystem.entity.Room"%>
...
<path
    ...
    <div class="row">
        <div class="col-4 hero p-5">
            <h1 class="text-center text-dark mb-5 text-capitalize text-grey">Room Details</h1>
            <ul class="card rounded p-4" style="list-style-type: none; font-size: 16px; background: rgba(255,255,255,0.8)!important;">
                <li class="my-2 text-capitalize text-dark d-flex justify-content-between">Room type<span class="fw-semibold">${room.roomType}</span></li>
                <li class="my-2 text-dark d-flex justify-content-between">Room price<span class="fw-semibold">&#8377;${room.price}</span></li>
                <li class="my-2 text-dark d-flex justify-content-between">Floor number<span class="fw-semibold">${room.roomFloorNumber}</span></li>
            </ul>
        </div>

        <div class="col-8 p-5 d-flex flex-column justify-content-center">
            <div class="row justify-content-center" style="gap: 40px;">
                <h2 class="text-center mb-3">Book Room</h2>
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <form id="bookingForm" action="${pageContext.request.contextPath}/booking/confirm" method="post" novalidate>
                            ...
                            <div class="form-group form-floating mb-3">
                                <input type="date" class="form-control" id="checkInDate" name="checkInDate" onchange="updateCheckOutMinDate()" required>
                                <label for="checkInDate" class="form-label">Check-In Date</label>
                                <div class="invalid-feedback">Check-In Date is required.</div>
                            </div>

                            <div class="form-group form-floating mb-3">
                                <input type="date" class="form-control" id="checkOutDate" name="checkOutDate" onchange="calculateTotalPrice()" required>
                                <label for="checkOutDate" class="form-label">Check-Out Date</label>
                                <div class="invalid-feedback">Check-Out Date is required.</div>
                            </div>

                            <div class="form-group form-floating mb-3">
                                <input type="text" class="form-control" id="totalPrice" name="totalPrice" value="${room.price}" readonly>
                                <label for="totalPrice" class="form-label">Total Price (in &#8377;)</label>
                            </div>

                            <button type="submit" class="button w-100 btn-block">Confirm Booking</button>
                        </form>
                    </div>
                </div>
            </div>
