	...
	<section>
		<div class="row">
			<div class="col-4 hero p-5">
				<h1 class="text-center text-dark mb-5 text-capitalize text-grey">Room
					Details</h1>
				<ul class="card rounded p-4"
					style="list-style-type: none; font-size: 16px; background: rgba(255, 255, 255, 0.8) !important;">
					<li
						class="my-2 text-capitalize text-dark d-flex justify-content-between">Room
						type<span class="fw-semibold">${room.roomType}</span>
					</li>
					<li class="my-2 text-dark d-flex justify-content-between">Room
						price<span class="fw-semibold">&#8377;${room.price}</span>
					</li>
					<li class="my-2 text-dark d-flex justify-content-between">Floor
						number<span class="fw-semibold">${room.roomFloorNumber}</span>
					</li>
				</ul>
			</div>
			...
			<div class="col-8 p-5 d-flex flex-column justify-content-center">
				<div class="row justify-content-center" style="gap: 40px;">
					...
					<div class="row justify-content-center">
						<div class="col-md-6">
							<form id="bookingForm"
								action="${pageContext.request.contextPath}/booking/confirm"
								method="post" novalidate>
								<input type="hidden" name="roomId" value="${room.roomId}">
								<input type="hidden" name="tenantId"
									value="${sessionScope.user.tenantId}"> <input
									type="hidden" id="roomPrice" value="${room.price}">

								<div class="form-group form-floating mb-3">
									<input type="date" class="form-control" id="checkInDate"
										name="checkInDate" onchange="updateCheckOutMinDate()" required>
									<label for="checkInDate" class="form-label">Check-In
										Date</label>
								...
								<div class="form-group form-floating mb-3">
									<input type="date" class="form-control" id="checkOutDate"
										name="checkOutDate" onchange="calculateTotalPrice()" required>
								...
								<div class="form-group form-floating mb-3">
									<input type="text" class="form-control" id="totalPrice"
										name="totalPrice" value="${room.price}" readonly> <label
										for="totalPrice" class="form-label">Total Price (in
										&#8377;)</label>
								</div>

								<button type="submit" class="button w-100 btn-block">Confirm
									Booking</button>
							</form>
						</div>
					</div>
...
<path d="M29.1089 40.401H2.88989V41.5512H29.1089V40.401Z" fill="#222831" />
			...
			<div
				...
				<div class="d-flex align-items-center justify-content-around w-75">
					...
					<ul class="list-unstyled">
						<li class="my-3"><a href="http://www.instagram.com"
							class="nav-link"><i class="fa-brands fa-instagram mx-2"></i>Instagram</a></li>
						<li class="my-3"><a href="http://www.facebook.com"
							class="nav-link"><i class="fa-brands fa-facebook mx-2"></i></i>Facebook</a></li>
