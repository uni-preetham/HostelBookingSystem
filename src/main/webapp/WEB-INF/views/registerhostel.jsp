...
<path
	...
	<section>
        ...
        <img style="max-height: 450px; position: absolute; left:130px; bottom:0;" src="https://raw.githubusercontent.com/uni-preetham/Test/master/1000041632-removebg.png">
        </div>
			<div class="col-8 p-5 d-flex flex-column justify-content-center">
				<h2 class="text-center mb-3">Add Hostel</h2>
				<div class="row justify-content-center">
					<div class="col-md-6">
						<form id="addHostelForm" method="post"
							action="${pageContext.request.contextPath}/hostel/createhostel"
							novalidate>
							<!-- Hostel Name -->
							<div class="form-group form-floating mb-2">
								<input id="hostelName" name="hostelName" class="form-control"
									placeholder="" required minlength="3" maxlength="100" /> <label
									for="hostelName">Hostel Name</label>
								<div class="invalid-feedback">Hostel Name is required.</div>
							</div>

							<!-- Hostel Location -->
							<div class="form-group form-floating mb-2">
								<input id="hostelLocation" name="hostelLocation"
									class="form-control" placeholder="" required minlength="3"
									maxlength="100" /> <label for="hostelLocation">Hostel
									Location</label>
								<div class="invalid-feedback">Hostel Location is required.</div>
							</div>
							...
							<!-- Hostel Amenities -->
							<div class="form-group form-floating mb-2">
								<textarea id="hostelAmenities" name="hostelAmenities"
									class="form-control" placeholder="" rows="3" maxlength="250"></textarea>
								<label for="hostelAmenities">Hostel Amenities</label>
								<div class="invalid-feedback">Hostel Amenities should be
									up to 250 characters long.</div>
							</div>

							<!-- Submit Button -->
							<button type="submit" class="button w-100 btn-block">Add
								Hostel</button>
						</form>
					</div>
				</div>
...
<path d="M29.1089 40.401H2.88989V41.5512H29.1089V40.401Z" fill="#222831" />
	...
	<script>
		...
		(function() {
			'use strict';
			var form = document.getElementById('addHostelForm');
