...
<path d="M29.1089 40.401H2.88989V41.5512H29.1089V40.401Z" fill="#222831" />
	...
	function filterBookings() {
		...
		bookingCards.forEach(card => {
			const checkInDate = new Date(card.getAttribute('data-checkindate'));

			// Calculate the time difference in months
			const diffInMonths = (currentDate.getFullYear() - checkInDate.getFullYear()) * 12 + (currentDate.getMonth() - checkInDate.getMonth());

			// Show or hide cards based on the filter
			if (filterValue === "all" || diffInMonths <= filterValue) {
